...
class RequestHeader: UITableViewHeaderFooterView {
    ...
    func setupViews() {
        ...
        addConstraintsWithFormat(format: "H:|-8-[v0]-8-|", view: nameLabel)
        addConstraintsWithFormat(format: "V:|[v0][v1(0.5)]|", view: nameLabel, bottomBorderView)
        
        addConstraintsWithFormat(format: "H:|[v0]|", view: bottomBorderView)
    }
...
class FriendRequestCell: UITableViewCell {
    ...
    func setupViews() {
        ...
        addConstraintsWithFormat(format: "H:|-16-[v0(52)]-8-[v1]|", view: requestImageView, nameLabel)
        
        addConstraintsWithFormat(format: "V:|-4-[v0]-4-|", view: requestImageView)
        addConstraintsWithFormat(format: "V:|-8-[v0]-8-[v1(24)]-8-|", view: nameLabel, confirmButton)
        
        addConstraintsWithFormat(format: "H:|-76-[v0(80)]-8-[v1(80)]", view: confirmButton, deleteButton)
        
        addConstraintsWithFormat(format: "V:[v0(24)]-8-|", view: deleteButton)
